    ...
    <section className="section" id="contact">
      <div className="container">
        ...
        <div className="contact-grid">
          ...
          {/* Minimal Form Side */}
          <div className="contact-minimal-form" style={{ maxWidth: '450px', width: '100%', margin: '0 auto', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '2.5rem', background: 'var(--bg-card)', boxShadow: '0 10px 40px rgba(0,0,0,0.05)' }}>
